...
public class Util {
	...
	public static void setCommonHttpMethod(HttpRequestBase httpMethod) {
		...
		// contextCoding
		httpMethod.setHeader("X-Avoscloud-Application-Id", "b5bPYWwAFjEKDNw7RjdA9m4c-gzGzoHsz");
		httpMethod.setHeader("X-Avoscloud-Application-Key", "ble3box0H90sEHCLFstJrMzg");
	...
	public static void main(String[] args) throws ClientProtocolException,
		...
		map.put("email", "ffff");
		map.put("nickName", "325433");
		map.put("age","45"); 
		System.out.println(simplePostInvoke(
				"http://www.sosoapi.com/demo/user/simple/add.htm", map));
	}
}
