...
import cc.zhanyun.service.domain.ResourcesService;
...
public class ResourcesApi {
	...
	List<ResourcesVO> resourcesGet() throws NotFoundException {
		...
		return resourcesService.selResources();
	}
	...
	public ResponseEntity<Void> resourcesoidDelete(
		...
		// do some magic!
		resourcesService.delResourcesOne(oid);
		return new ResponseEntity<Void>(HttpStatus.OK);
	}
	...
	Resources resourcesoidGet(
		...
		// do some magic!
		return resourcesService.selResourcesOne(oid);
	}
